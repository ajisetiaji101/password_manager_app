...
class _PasswordScreenState extends State<PasswordScreen> {
  ...
  Future<void> _loadPasswords() async {
    ...
    db.query(
      'passwords', where: 'userId = ?', whereArgs: [widget.userId],
    );
  ...
  Future<void> _addOrEditPassword({Password?password}) async {
    ...
    final passwordController = TextEditingController( text: password != null ? password.password:'');
    final passwordViewController = TextEditingController( text: password != null ? password.passwordView:'');
    final passwordEncryptedController = TextEditingController( text: password != null ? password.passwordEncrypted:'');
            ...
            content: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Password Encrypted'),
                  readOnly: true,
                ),
                TextField(
                  controller: passwordEncryptedController,
                  decoration: InputDecoration(labelText: 'Password View'),
                  enabled: false,
                ),
              ],
            ),
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  String encryptedPassword = EncryptionHelper.encryptPassword(passwordController.text, usernameController.text); // Ganti dengan enkripsi password
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(itemCount: _passwords.length, itemBuilder: (context, index) {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _addOrEditPassword(), child: Icon(Icons.add),),
    );
  }
}